...
class BasicListeningConnectCodePolicy
{
     ...
     */
    public function view(User $user, BasicListeningConnectCode $basicListeningConnectCode): bool
    {
     ...
     */
    public function update(User $user, BasicListeningConnectCode $basicListeningConnectCode): bool
    {
     ...
     */
    public function delete(User $user, BasicListeningConnectCode $basicListeningConnectCode): bool
    {
     ...
     */
    public function forceDelete(User $user, BasicListeningConnectCode $basicListeningConnectCode): bool
    {
     ...
     */
    public function restore(User $user, BasicListeningConnectCode $basicListeningConnectCode): bool
    {
     ...
     */
    public function replicate(User $user, BasicListeningConnectCode $basicListeningConnectCode): bool
    {
