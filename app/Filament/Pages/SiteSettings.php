...
class SiteSettings extends Page implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $this->form->fill([
            ...
            'ept_online_enabled' => SiteSetting::isEptOnlineEnabled(),
            ...
            ->schema([
                ...
                Section::make('EPT Registration')
                    ...
                    ->schema([
                        ...
                        Toggle::make('ept_online_enabled')
                            ->label('Pendaftaran EPT Online Dibuka')
                            ->helperText('Jika nonaktif, pilihan EPT Online disembunyikan — peserta hanya bisa mendaftar EPT Offline.')
                            ->onColor('success')
                            ->offColor('danger'),
    ...
    public function save(): void
    {
        ...
        SiteSetting::set('ept_online_enabled', $data['ept_online_enabled'] ?? true);
